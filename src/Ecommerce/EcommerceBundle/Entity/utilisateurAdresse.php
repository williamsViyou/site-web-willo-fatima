...
class utilisateurAdresse
{
   ...
   /**
    *@ORM\ManyToOne(targetEntity="MyUser\UtilisateurBundle\Entityy\User", inversedBy="adresse")
  ...
  /**
    ...
    public function setUtilisateur(\MyUser\UtilisateurBundle\Entity\User $utilisateur )
